...
export default function SpeechHelpText() {
  return (
    <div id="helpTextContainer">
      ...
      <p>
        There are some sounds that just don't work very well in speech recognition. Usually problems occur with short,
        one syllable words. If you can get your child to use the word in a sentence it will be much easier for the
        program to understand him/her. Your other options are to skip the word using the green arrow button, or you can
        remove that word from the word list for this game <strong>(premium members only).</strong>
      </p>
      <p>
